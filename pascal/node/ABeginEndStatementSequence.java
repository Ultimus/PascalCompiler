...
public final class ABeginEndStatementSequence extends PStatementSequence
{
    private TBegin _begin_;
    private PStatementSequence _statementSequence_;
    private TEnd _end_;

    public ABeginEndStatementSequence()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new ABeginEndStatementSequence(
    ...
    {
        ((Analysis) sw).caseABeginEndStatementSequence(this);
    }
