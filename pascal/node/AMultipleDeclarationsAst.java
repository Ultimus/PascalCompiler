...
public final class AMultipleDeclarationsAst extends PAst
{
    private PAst _left_;
    private PAst _m_;
    private PAst _right_;

    public AMultipleDeclarationsAst()
    {
        // Constructor
    }
    ...
    public AMultipleDeclarationsAst(
        ...
        @SuppressWarnings("hiding") PAst _m_,
    ...
    public Object clone()
    {
        return new AMultipleDeclarationsAst(
    ...
    {
        ((Analysis) sw).caseAMultipleDeclarationsAst(this);
    }
