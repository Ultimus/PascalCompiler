...
public final class AOpenIfElseOpenIfStatement extends POpenIfStatement
{
    private TIf _if_;
    ...
    public AOpenIfElseOpenIfStatement()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AOpenIfElseOpenIfStatement(
            cloneNode(this._if_),
    ...
    {
        ((Analysis) sw).caseAOpenIfElseOpenIfStatement(this);
    }
