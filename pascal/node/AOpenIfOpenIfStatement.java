...
public final class AOpenIfOpenIfStatement extends POpenIfStatement
{
    private TIf _if_;
    ...
    public Object clone()
    {
        return new AOpenIfOpenIfStatement(
            cloneNode(this._if_),
    ...
    {
        ((Analysis) sw).caseAOpenIfOpenIfStatement(this);
    }
